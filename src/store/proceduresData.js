...
export const EQUIPMENT_NAMES = {
    ...
    NSS_09: "0.9% NSS",
    NSS: "NSS",
    COTTON_BUD_5: "ไม้พันสำลี 5 ก้าน",
    COTTON_BUD: "สำลีก้าน",
    AMBU_BAG: "Ambu Bag",
    ...
    TRAY: "ถาดสี่เหลี่ยม",
    KY_JELLY: "เจลหล่อลื่น",
    MICROPORE: "Micropore",
    URINE_BAG: "Urine Bag",
    URINE_CATHETER: "สายสวนปัสสาวะ",
    EYE_PAD: "ผ้าปิดตา",
    NEEDLE: "เข็ม",
...
export const equipmentData = {
    suction: [
        ...
        { id: 5, name: EQUIPMENT_NAMES.COTTON_BUD_5, img: cotton_bud, isCorrect: true },
    ...
    suction: [
        {
            ...
            options: [
                ...
                "ผู้ป่วยมีค่า SpO₂ ปกติ และไม่มีเสียงเสมหะในทางเดินหายใจ",
        ...
        {
            id: 8, question: "ป่วยใส่ท่อช่วยหายใจได้รับการดูดเสมหะแล้ว 2 ครั้ง แต่ยังมีเสียงเสมหะชัดเจน พยาบาลควรปฏิบัติอย่างไร ?",
            options: [
    ...
    foley_catheter: [
        ...
        },
        {
            ...
            options: [
                ...
                "ใท่านอนหงายราบ (supine position)",
...
export const ethicsData = {
    suction: [
        "เคารพสิทธิผู้ป่วย อธิบายวัตถุประสงค์และขอความยินยอมจากผู้ป่วยหรือญาติก่อนทำหัตถการทุกครั้ง หากผู้ป่วยสามารถรับรู้และสื่อสารได้ คำนึงถึงความปลอดภัยและไม่ก่ออันตราย ฏิบัติตามหลักปลอดเชื้อ หากเกิดความผิดพลาดระหว่างการทำหัตถการ ต้องรายงานเหตุการณ์ตามความเป็นจริง ไม่ปกปิดข้อมูล"
    ],
    foley_catheter: [
